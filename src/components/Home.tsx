...
export default function Home() {
  return (
    <section className="pt-60 pb-30 flex items-center justify-center bg-[linear-gradient(90deg,_rgb(3,7,18)_0%,_rgb(30,30,37)_35%,_rgb(6,5,5)_100%)] text-white px-4">
